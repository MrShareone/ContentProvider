...
public class DatabaseProvider extends ContentProvider {
    ...
    public static final int CATEGORY_IMTE = 3;

    public static final String AUTHORITY = "com.example.databasetest.provider";
    private static UriMatcher uriMatcher;  //这里面存放了uri对应常量值的键值对
    ...
    static {
        ...
        uriMatcher.addURI(AUTHORITY, "category/#", CATEGORY_IMTE);
    }
...
//        throw new UnsupportedOperationException("Not yet implemented");
        ...
        switch (uriMatcher.match(uri)){  //用uri来匹配常量，判断是哪一种访问情形
            case BOOK_DIR:
